...
function checkPasswordMatch()
{
    ...
    if (password != confirmPassword)
        ...
        document.getElementById("confirm_password").style.backgroundColor="red";
            ...
            <div align="center"><input type="radio" name="usertype" value="jobseeker" required>JobSeeker 
<input type="radio" name="usertype" value="Corporate" required>Corporate</div> 
